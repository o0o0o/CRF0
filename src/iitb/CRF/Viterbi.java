...
// Viterbi is believed to be one of the most important algorithms in probabilistic inference.
// this implementation is heavily binded with CRF model.
public class Viterbi implements Serializable {
    private static final long serialVersionUID = 8122L;
    protected CRF model;
    // beamsize is an important parametre.
    ...
    protected class Entry {
        ...
        protected Entry(int beamsize, int id, int pos) {
            ...
            // beamsize is actually solution length
            for (int i = 0; i < solns.length; i++)
                // initialize a new Soln with id and pos. what is a Soln?
                // id as label, pos := position
